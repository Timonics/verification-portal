...
export function CacSearchForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* RC Number */}
      <div>
        <Label htmlFor="rc" className="text-gray-700 font-medium">
          RC Number
        </Label>
      ...
      <div>
        ...
        >
          ...
          <SelectContent className="bg-white p-2">
            <SelectItem value="COMPANY" className="hover:text-purple-500">
              Company
            </SelectItem>
            <SelectItem value="BUSINESS_NAME" className="hover:text-purple-500">
              Business Name
            </SelectItem>
            <SelectItem
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1">
              ...
              <br />• Business type (Company/Business Name/etc.)
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 bg-gray-50 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500 mt-1">
              Search results are sourced directly from the CAC database.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start space-x-3">
        ...
        >
          I confirm that I am authorized to search for this business
          information.
        </Label>
      </div>
      ...
      <div className="flex gap-3 pt-4">
        <Button
          type="submit"
          disabled={isLoading || !rcNumber || !consent}
